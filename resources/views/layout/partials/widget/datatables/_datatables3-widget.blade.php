        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar">
                <a href="#" class="btn btn-success font-weight-bolder font-size-sm">
                    <span class="svg-icon svg-icon-md svg-iconwhite">
                ...
                <div class="tab-pane fade show active" id="kt_tab_pane_11_1" role="tabpanel" aria-labelledby="kt_tab_pane_11_1">
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center">
                            <thead>
                                <tr class="text-left">
                                    <th class="p-0" style="widht:20px">
                                        <label class="checkbox checkbox-lg checkbox-inline">
                                            <input type="checkbox" value="1">
                                            <span></span>
                                        </label>
                                    </th>
                                    <th class="pr-0" style="widht:50px">authors</th>
                                    <th style="min-widht:200px"></th>
                                    <th style="min-widht:200px">company</th>
                                    <th style="min-widht:150px">progress</th>
                                    <th class="pr-0 text-right" style="min-widht:150px;">action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="pr-0">
                                        {{-- symbol symbol-50 symbol-light mt-1 --}}
                                        <div class="symbol symbol-50 symbol-light mt-1">
                                            <span class="symbol-label">
                                                <img src="{{asset('media/svg/avatars/001-boy.svg')}}" alt="" class="h-75 align-self end">
                                            </span>
                                        </div>
                                    </td>
                                    <td class="pl-0">
                                        <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Brad Simmons</a>
                                        <div class="text-muted font-weight-bold d-block">HTML, JS, ReactJS</div>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Intertico</span>
                                        <span class="text-muted font-weight-bold">Web, UI/UX Design</span>
                                    </td>
                                    <td class="d-flex flex-column w-100 mr-2">
                                        ...
                                        <div class="progress progress-xs w-100 mr-2">
                                            <div class="progress-bar bg-danger" role="progressbar" style="width:65%" aria-valuenow="50" aria-valuemax="100"></div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-0">
                                        ...
                                        <div class="symbol symbol-50 symbol-light mt-1">
                                            <span class="symbol-label">
                                                <img src="{{asset('media/svg/avatars/018-girl-9.svg')}}" alt="" class="h-75 align-self end">
                                            </span>
                                        </div>
                                    </td>
                                    <td class="pl-0">
                                        <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Jessie Clarcson</a>
                                        <div class="text-muted font-weight-bold d-block">C#, ASP.NET, MS SQL</div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="d-flex flex-column w-100 mr-2">
                                        ...
                                        <div class="progress progress-xs w-100 mr-2">
                                            <div class="progress-bar bg-success" role="progressbar" style="width:83%" aria-valuenow="50" aria-valuemax="100"></div>
                                        </div>
                                    </td>
                                    <td class="pr-0 text-right">
                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="pl-0">
                                        ...
                                        <div class="text-muted font-weight-bold d-block">PHP, Laravel, VueJS</div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="d-flex flex-column w-100 mr-2">
                                        ...
                                        <div class="progress progress-xs w-100 mr-2">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width:47%" aria-valuenow="50" aria-valuemax="100"></div>
                                        </div>
                                    </td>
                                    <td class="pr-0 text-right">
                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="pr-0">
                                        ...
                                        <div class="symbol symbol-50 symbol-light mt-1">
                                            <span class="symbol-label">
                                                <img src="{{asset('media/svg/avatars/014-girl-7.svg')}}" alt="" class="h-75 align-self end">
                                            </span>
                                        </div>
                                    </td>
                                    <td class="pl-0">
                                        <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Natali Trump</a>
                                        <div class="text-muted font-weight-bold d-block">PostgreSQL, ReactJS</div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="d-flex flex-column w-100 mr-2">
                                        ...
                                        <div class="progress progress-xs w-100 mr-2">
                                            <div class="progress-bar bg-danger" role="progressbar" style="width:71%" aria-valuenow="50" aria-valuemax="100"></div>
                                        </div>
                                    </td>
                                    <td class="pr-0 text-right">
                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
...
<div class="col-xl-4">
    <div class="card card-custom gutter-b card-stretch bg-light-danger  ">
       {{-- begin::Header --}}
        ...
        <div class="card-body pt-0">
            <div class="d-flex align-items-center flex-wrap mb-8">
               <div class="symbol symbol-50 symbol-light mr-5">
                    <span class="symbol-label">
                        <img src="{{asset('media/svg/misc/006-plurk.svg')}}" alt="" class="h-50 align-selft-center">
                    </span>
               </div>
            ...
            <div class="d-flex align-items-center flex-wrap mb-8">
                <div class="symbol symbol-50 symbol-light mr-5">
                     <span class="symbol-label">
                         <img src="{{asset('media/svg/misc/015-telegram.svg')}}" alt="" class="h-50 align-selft-center">
                     </span>
                </div>
                <div class="d-flex flex-column flex-grow-1 mr-2">
            ...
            <div class="d-flex align-items-center flex-wrap mb-8">
                <div class="symbol symbol-50 symbol-light mr-5">
                     <span class="symbol-label">
                         <img src="{{asset('media/svg/misc/003-puzzle.svg')}}" alt="" class="h-50 align-selft-center">
                     </span>
                </div>
                <div class="d-flex flex-column flex-grow-1 mr-2">
            ...
            <div class="d-flex align-items-center flex-wrap mb-8">
                <div class="symbol symbol-50 symbol-light mr-5">
                     <span class="symbol-label">
                         <img src="{{asset('media/svg/misc/005-bebo.svg')}}" alt="" class="h-50 align-selft-center">
                     </span>
                </div>
                <div class="d-flex flex-column flex-grow-1 mr-2">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <div class="symbol symbol-50 symbol-light mr-5">
                     <span class="symbol-label">
                         <img src="{{asset('media/svg/misc/014-kickstarter.svg')}}" alt="" class="h-50 align-selft-center">
                     </span>
                </div>
                <div class="d-flex flex-column flex-grow-1 mr-2">
                     <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Bestseller Theme</a>
                     <span class="text-muted font-weight-bold">Disco, Retro, Sport</span>
                </div>
                <span class="label label-xl label-light label-inline my-lg-0 my-2 text-dark-50 font-weight-bolder">+4500$</span>
            </div>
        </div>
